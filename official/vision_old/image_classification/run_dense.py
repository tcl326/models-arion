...
cmd1 = "python3 densenet_imagenet_main_arion.py --data_dir=/tmp/arion/scalability/train1 --train_epochs=10\
 --cnn_model={} --is_arion={}"
cmd2 =  "python3 densenet_imagenet_main_arion.py --data_dir=/tmp/arion/scalability/train1 --train_epochs=10\
 --cnn_model={} --is_arion={} --arion_strategy={} --arion_patch_tf={}"


for cnn_model in ['densenets11']:
